...
FurlPay handles money and personal data. Publishing a vulnerability, a live
credential, or another user's transaction or identity data in a public issue is
a violation of this Code, regardless of intent — the disclosure itself is the
harm, and it cannot be undone by deleting the comment.

Report security issues privately through [SECURITY.md](SECURITY.md) instead.
Doing so is welcomed, not penalised.
...
reported to the maintainers at **support@furlpay.com**. All complaints will be
...
with clarity around the nature of the violation.
...
behaviour, including a period of no interaction with those involved.
